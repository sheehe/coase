...
- **/idea-discovery / /experiment-bridge**: 不直接参与。
...
- **paper-writing**: The paper that the presentation is based on
- **table**: Embed formatted regression tables in slides
- **/plot**: Generate figures and charts for presentation slides
- **/method**: Write the methodology slide content